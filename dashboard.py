...
fig.add_annotation(x=0.20, y=0.5, text="2020", font=dict(size=18, color='black'), showarrow=False)
fig.add_annotation(x=0.81, y=0.5, text=f"{filtered_data['year'].max()}", font=dict(size=18, color='black'), showarrow=False)
